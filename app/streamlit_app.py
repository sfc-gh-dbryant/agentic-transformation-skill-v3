...
=============================
Parameterized SA/customer deployment and management interface.
Deploys and manages the Agentic Data Foundry (Enriched + Analytics) in any Snowflake account.

Tabs:
  1  Setup            — Bootstrap, model validation, Foundation table discovery
  2  Context          — Pipeline context: business description, domain, Gold goals, constraints
  3  Contracts        — Edit structural rules injected into LLM prompts
  4  Directives       — Edit per-table business intent
  5  Workflow         — Run agentic Enriched pipeline with live phase display
  6  Analytics Builder — Review + execute or export Analytics DDL proposals
  7  Registry         — Transformation Registry: lineage map + learnings
  8  Observe          — Observability: KPIs, executor perf, learning intelligence loop
"""
...
st.set_page_config(page_title="Agentic Transformation Skill", page_icon="🤖", layout="wide")
...
def render_sidebar():
    st.sidebar.title("🤖 Framework Status")
